# OpenCockpit (CPT)
OpenCockpit is a set of enigma2 plugins that focuses on enhancing the handling of tv recordings and Mediathek movie files. 

The basic principle of those plugins is seemless integration into the Enigma2 base system, concurrent execution of plugins not blocking the OS, and completion of long running operations when powering off the system.
...
-->
- Plugins are being ported from DreamOS

## Links
- Installation: https://dream-alpha.github.io/OpenCockpit
